...
void main()
{
    ...
    u_xlat24 = max(u_xlat24, 0.00200000009);
    u_xlat39 = (-u_xlat24) + 1.0;
    u_xlat4.x = abs(u_xlat36) * u_xlat39 + u_xlat24;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    if(u_xlatb38){
        ...
        u_xlat4.xyz = fma(FGlobals.hlslcc_mtx4x4unity_ProbeVolumeWorldToObject[2].xyz, input.TEXCOORD2.zzz, u_xlat4.xyz);
        u_xlat4.xyz = u_xlat4.xyz + FGlobals.hlslcc_mtx4x4unity_ProbeVolumeWorldToObject[3].xyz;
        u_xlat4.xyz = (bool(u_xlatb39)) ? u_xlat4.xyz : input.TEXCOORD2.xyz;
        u_xlat4.xyz = u_xlat4.xyz + (-FGlobals.unity_ProbeVolumeMin.xyzx.xyz);
        u_xlat4.yzw = u_xlat4.xyz * FGlobals.unity_ProbeVolumeSizeInv.xyzx.xyz;
    ...
    u_xlat37 = (u_xlatb38) ? u_xlat39 : u_xlat37;
    u_xlat38 = (-FGlobals._Glossiness) + 1.0;
    u_xlat39 = dot((-u_xlat1.xyz), input.TEXCOORD1.xyz);
    u_xlat39 = u_xlat39 + u_xlat39;
    u_xlat4.xyz = fma(input.TEXCOORD1.xyz, (-float3(u_xlat39)), (-u_xlat1.xyz));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat18 = u_xlat18 * FGlobals._LightPositionRange.w;
    u_xlat18 = u_xlat18 * FGlobals._LightProjectionParams.w;
    u_xlat26 = _ShadowMapTexture.sample(sampler_ShadowMapTexture, u_xlat7.xyz).x;
    u_xlatb18 = u_xlat26<u_xlat18;
    u_xlat18 = (u_xlatb18) ? FGlobals._LightShadowData.x : 1.0;
    u_xlat25 = u_xlat25 + u_xlat18;
    u_xlat25 = clamp(u_xlat25, 0.0f, 1.0f);
    u_xlat10.x = min(u_xlat25, u_xlat10.x);
    u_xlat25 = (u_xlatb2) ? u_xlat10.x : u_xlat25;
...
void main()
{
    ...
    u_xlat10_7 = texture(_ShadowMapTexture, u_xlat7.xyz);
